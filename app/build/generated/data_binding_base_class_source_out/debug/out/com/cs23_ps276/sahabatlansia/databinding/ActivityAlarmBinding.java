...
public final class ActivityAlarmBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView timeAndData;

  @NonNull
  public final TextView title;

  private ActivityAlarmBinding(@NonNull LinearLayout rootView, @NonNull Button closeButton,
      @NonNull TextView description, @NonNull ImageView imageView, @NonNull TextView timeAndData,
  ...
  public static ActivityAlarmBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.timeAndData;
      TextView timeAndData = ViewBindings.findChildViewById(rootView, id);
      if (timeAndData == null) {
        break missingId;
      }
      ...
      return new ActivityAlarmBinding((LinearLayout) rootView, closeButton, description, imageView,
          timeAndData, title);
    }
