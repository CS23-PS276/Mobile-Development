...
public final class FragmentProfileBinding implements ViewBinding {
  ...
  private FragmentProfileBinding(@NonNull ConstraintLayout rootView,
      @NonNull Button btnCariCaregiver, @NonNull RelativeLayout relativeLayout,
      @NonNull RecyclerView rvCaregiver, @NonNull TextView textView6) {
  ...
  public static FragmentProfileBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentProfileBinding((ConstraintLayout) rootView, btnCariCaregiver,
          relativeLayout, rvCaregiver, textView6);
    }
