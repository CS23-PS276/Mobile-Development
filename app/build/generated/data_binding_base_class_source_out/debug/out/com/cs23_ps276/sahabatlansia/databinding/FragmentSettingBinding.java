...
public final class FragmentSettingBinding implements ViewBinding {
  ...
  private FragmentSettingBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull TextView email, @NonNull TextView password, @NonNull RelativeLayout relativeLayout,
      @NonNull Button saveButton, @NonNull TextView textView6,
  ...
  public static FragmentSettingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentSettingBinding((ConstraintLayout) rootView, confirmPassword,
          edConfirmPassword, edEmail, edPassword, email, password, relativeLayout, saveButton,
          textView6, tilConfirmPassword, tilEmail, tilPassword);
    }
